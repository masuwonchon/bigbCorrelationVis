...
echo "src ip: $srcip, dest ip: $dstip, signature: $signature"
...
signature=${SignatureList[$signaturenum]}
MESSAGES=('{"alert": {"gid": 1, "action": "allowed", "signature_id": 2101411, "rev": 12, "severity": 2, "signature": "'"$signature"'", "category": "Attempted Information Leak"}, "timestamp": "2018-08-23T17:07:29.175374+0900", "flow_id": 1980263043280142, "dest_port": "'$dstport'", "src_port": "'$srcport'", "stream": 0, "in_iface": "eth4", "event_type": "alert", "src_ip": "'$srcip'", "app_proto": "failed", "dest_ip": "'$dstip'", "packet_info": {"linktype": 1}, "proto": "UDP", "vlan": 51, "payload": "MCgCAQAEBnB1YmxpY6EbAgIBCAIBAAIBADAPMA0GCSsGAQQBlQsBAgUA", "packet": "ABsXAAEnACYKJMDACABFAABGVlwAAH4RgOasG+UBrBAoN9lbAKEAMk93MCgCAQAEBnB1YmxpY6EbAgIBCAIBAAIBADAPMA0GCSsGAQQBlQsBAgUA"}')
